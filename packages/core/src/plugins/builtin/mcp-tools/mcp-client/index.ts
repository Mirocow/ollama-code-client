...
import { DiscoveredMCPTool } from '../mcp-tool/index.js';
import type { McpToolAnnotations } from '../mcp-tool/index.js';
import { SdkControlClientTransport } from '../sdk-control-client-transport/index.js';
